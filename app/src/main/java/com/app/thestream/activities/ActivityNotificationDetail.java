...
import static com.app.thestream.utils.Constant.BANNER_CHANNEL_DETAIL;
import static com.app.thestream.utils.Constant.INTERSTITIAL_AD_CHANNEL_DETAIL;
import static com.app.thestream.utils.Constant.NATIVE_AD_CHANNEL_DETAIL;
...
import com.app.thestream.databases.dao.AppDatabase;
import com.app.thestream.databases.dao.ChannelEntity;
import com.app.thestream.databases.dao.DAO;
...
import com.app.thestream.utils.PopupMenu;
...
public class ActivityNotificationDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        str_channel_id = intent.getStringExtra("id");
    ...
    private void requestPostData() {
        ...
        mCompositeDisposable.add(apiInterface.getChannelDetail(str_channel_id)
    ...
    private void displaySuggested(List<Channel> list) {
        ...
        adapterSuggested.setOnItemClickListener((view, obj, position) -> {
            ...
            intent.putExtra("id", obj.channel_id);
    ...
    private void refreshReadLaterMenu(Channel channel) {
